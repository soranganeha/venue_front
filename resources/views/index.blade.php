...
<!-- Mirrored from jituchauhan.com/wedding/wedding-new/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Aug 2020 09:24:06 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <title>Venue System | Find The Best Wedding Venues</title>
    <!-- Bootstrap -->
    ...
    <!-- favicon icon -->
    <link rel="shortcut icon" href="{{asset('images/front_images/favicon.ico')}}" type="image/x-icon">
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 top-message">
                    <p>WELCOME TO VENUE BOOKING SYSEM</p>
                </div>
                <div class="col-md-6 top-links">
                    <ul class="listnone">
                        ...
                        <li><a href="{{url('/regiser-login')}}">REGISTER / LOGIN</a></li>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-12 logo">
                    <div class="navbar-brand">
                        <a href="index.html"><img src="{{asset('images/front_images/logo.png')}}" alt="Wedding Venues" class="img-responsive"></a>
                    </div>
                </div>
    ...
    <div class="slider-bg">
        ...
        <div id="slider" class="owl-carousel owl-theme slider">
            <div class="item"><img src="{{asset('images/front_images/hero-image-3.jpg')}}" alt="Wedding couple just married"></div>
            <div class="item"><img src="{{asset('images/front_images/hero-image-2.jpg')}}" alt="Wedding couple just married"></div>
            <div class="item"><img src="{{asset('images/front_images/hero-image.jpg')}}" alt="Wedding couple just married"></div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="feature-block feature-center">
                        <!-- feature block -->
                        <div class="feature-icon"><img src="{{asset('images/front_images/vendor.svg')}}" alt=""></div>
                ...
                <div class="col-md-4">
                    <div class="feature-block feature-center">
                        <!-- feature block -->
                        <div class="feature-icon"><img src="{{asset('images/front_images/mail.svg')}}" alt=""></div>
                ...
                <div class="col-md-4">
                    <div class="feature-block feature-center">
                        <!-- feature block -->
                        <div class="feature-icon"><img src="{{asset('images/front_images/couple.svg')}}" alt=""></div>
            ...
            <div class="row ">
                <div class="col-md-4">
                    ...
                    <div class="vendor-box">
                        <div class="vendor-image">
                            <!-- vendor pic -->
                            <a href="#"><img src="{{asset('images/front_images/vendor-1.jpg')}}" alt="wedding vendor" class="img-responsive"></a>
                ...
                <div class="col-md-4">
                    ...
                    <div class="vendor-box">
                        <div class="vendor-image">
                            <!-- vendor pic -->
                            <a href="#"><img src="{{asset('images/front_images/vendor-4.jpg')}}" alt="wedding vendor" class="img-responsive"></a>
                ...
                <div class="col-md-4 vendor-box">
                    ...
                    <div class="vendor-image">
                        <!-- vendor pic -->
                        <a href="#"><img src="{{asset('images/front_images/vendor-3.jpg')}}" alt="wedding vendor" class="img-responsive"></a>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 location-block">
                    <!-- location block -->
                    <div class="vendor-image">
                        <a href="#"><img src="{{asset('images/front_images/location-pic.jpg')}}" alt="" class="img-responsive"></a> <a href="#" class="venue-lable"><span class="label label-default">New York City</span></a> </div>
                </div>
                <!-- /.location block -->
                <div class="col-md-4 location-block">
                    <!-- location block -->
                    <div class="vendor-image">
                        <a href="#"><img src="{{asset('images/front_images/location-pic-2.jpg')}}" alt="" class="img-responsive"></a> <a href="#" class="venue-lable"><span class="label label-default">Sydney</span></a> </div>
                </div>
                <!-- /.location block -->
                <div class="col-md-4 location-block">
                    <!-- location block -->
                    <div class="vendor-image">
                        <a href="#"><img src="{{asset('images/front_images/location-pic-3.jpg')}}" alt="" class="img-responsive"></a> <a href="#" class="venue-lable"><span class="label label-default">Russia</span></a> </div>
                </div>
                <!-- /.location block -->
                <div class="col-md-8 location-block">
                    <!-- location block -->
                    <div class="vendor-image">
                        <a href="#"><img src="{{asset('images/front_images/location-pic-4.jpg')}}" alt="" class="img-responsive"></a> <a href="#" class="venue-lable"><span class="label label-default">Germany</span></a> </div>
                </div>
                <!-- /.location block -->
                <div class="col-md-4 location-block">
                    <!-- location block -->
                    <div class="vendor-image">
                        <a href="#"><img src="{{asset('images/front_images/location-pic-5.jpg')}}" alt="" class="img-responsive"></a> <a href="#" class="venue-lable"><span class="label label-default">Paris</span></a> </div>
                </div>
                <!-- /.location block -->
            </div>
        </div>
                ...
                <div class="col-md-12 tp-testimonial">
                    <div id="testimonial" class="owl-carousel owl-theme">
                        <div class="item testimonial-block">
                            <div class="couple-pic"><img src="{{asset('images/front_images/couple.jpg')}}" alt="" class="img-circle"></div>
                        ...
                        <div class="item testimonial-block">
                            <div class="couple-pic"><img src="{{asset('images/front_images/couple-2.jpg')}}" alt="" class="img-circle"></div>
                            <div class="feedback-caption">
                        ...
                        <div class="item testimonial-block">
                            <div class="couple-pic"><img src="{{asset('images/front_images/couple-3')}}.jpg" alt="" class="img-circle"></div>
                            <div class="feedback-caption">
                        ...
                        <div class="item testimonial-block">
                            <div class="couple-pic"><img src="{{asset('images/front_images/couple-4.jpg')}}" alt="" class="img-circle"></div>
                            <div class="feedback-caption">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 couple-block">
                    <div class="couple-icon"><img src="{{asset('images/front_images/couple.svg')}}" alt=""></div>
                    <h2>Are you couple find the venue ?</h2>
                    <p>Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).</p>
                    <a href="#" class="btn btn-primary">Find Vendor</a> </div>
                <div class="col-md-6 vendor-block">
                    <div class="vendor-icon"><img src="{{asset('images/front_images/vendor.svg')}}" alt=""></div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5 ft-aboutus">
                    <h2>Wedding Venue</h2>
                    <p>At Wedding Venue our purpose is to help people find great online network connecting wedding suppliers and wedding couples who use those suppliers. <a href="#">Start Find Vendor!</a></p>
